class CenterSerializer < ActiveModel::Serializer
	attributes :id, :center_type, :image_url, :refugees_number, :description, :address, :name, :phone_number, :email, :contact_email, :created_at, :updated_at, :latitude, :longitude
